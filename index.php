...
<html lang="en">
    ...
    <body>
        ...
        <section class="slider-pro slider" id="slider">
            <div class="sp-slides">
                ...
                <div class="sp-slide main-slides">
                    ...
                    <p class="sp-layer" data-position="center" data-vertical="15%" data-show-delay="2000" data-hide-delay="200" data-show-transition="left" data-hide-transition="right">Lorem ipsum dolor sit amectetur adipici</p>
                </div>
                <!-- Slides -->
                <!-- Slides End -->
                <div class="sp-slide main-slides">
                ...
                <div class="sp-slide main-slides">
                    ...
                    <p class="sp-layer" data-position="center" data-vertical="15%" data-show-delay="2000" data-hide-delay="200" data-show-transition="left" data-hide-transition="right">Lorem ipsum dolor sit ansectetur adipis</p>
                </div>
                <!-- Slides -->
            </div>
        </section>
        ...
        <section id="portfolio" class="bgSection portfolio-section">
            ...
            <!-- Section Header End -->
            <div class="portfolio-lassi wow fadeIn" data-wow-duration="2s">
                <!-- Works -->
                <div id="portfolio-filter" class="portfolio-filter-btn-group">
                    <ul>
                        <li>
                            <a href="#" class="selected" data-filter="*">ALL</a>
                            <a href="#" data-filter=".milk">Milk</a>
                            <a href="#" data-filter=".dahi">Dahi</a>
                            <a href="#" data-filter=".lassi">Lassi</a>
                            <a href="#" data-filter=".chach">Chach</a>
                        </li>
                    </ul>
                </div>
                <!-- Filter Button Start -->
                <div class="portfolio-items">
                    <!-- Filter Button End -->
                    <div class="item portfolio-item milk">
                        ...
                        <div class="portfolio-details-wrapper">
                            <div class="portfolio-details">
                                <div class="portfolio-meta-btn">
                                    <ul class="work-meta">
                                        <li class="lighbox">
                                            <a href="images/img-portfolio/portfolio1.jpg" class="featured-work-img">
                    ...
                    <!-- Portfolio Items -->
                    <!-- Portfolio Items End -->
                    <div class="item portfolio-item dahi">
                        ...
                        <div class="portfolio-details-wrapper">
                            <div class="portfolio-details">
                                <div class="portfolio-meta-btn">
                                    <ul class="work-meta">
                                        <li class="lighbox">
                                            <a href="images/img-portfolio/portfolio2.jpg" class="featured-work-img">
                                                <i class="fa fa-search-plus"></i>
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <!-- Portfolio Items -->
                    <!-- Portfolio Items End -->
                    <div class="item portfolio-item lassi">
                        ...
                        <div class="portfolio-details-wrapper">
                            <div class="portfolio-details">
                                <div class="portfolio-meta-btn">
                                    <ul class="work-meta">
                                        <li class="lighbox">
                                            <a href="images/img-portfolio/portfolio3.jpg" class="featured-work-img">
                                                <i class="fa fa-search-plus"></i>
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <!-- Portfolio Items -->
                    <div class="item portfolio-item chach">
                        <img src="images/img-portfolio/portfolio1.jpg" alt=""/>
                        <div class="portfolio-details-wrapper">
                            <div class="portfolio-details">
                                <div class="portfolio-meta-btn">
        ...
        <section id="about" class="about-sec section-wrapper description">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                        <h2>
                            <span class="highlight-text">About Us</span>
                        </h2>
                        <p class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">We provide dairy products .</p>
                    </div>
                    <!-- Section Header -->
            ...
            <div class="teams-wrapper wow bounceIn">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                            <h2>
                                <span class="highlight-text-inverted">The People Behind</span>
                            </h2>
                            <p class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod, nam corporis quas, saepe minima error aperiam dolorum aliquam, quis deserunt eos eius quisquam odio itaque.</p>
                        </div>
                        <!-- Section Header -->
        ...
        <section class="menus style3" id="menuCard">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                        <h2>
                            <span class="highlight-text">Product Catalog</span>
                        </h2>
                        <p class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">We provide these dairy products</p>
                    </div>
                    <!-- Section Header -->
                        ...
                        <div class="menu row">
                            <div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="menu-column">
                                    <div class="food">
                                        <div class="food-desc">
                                            <h6 class="food-name">Full Cream Milk</h6>
                                            <div class="dots"></div>
                    ...
                    <div class="contact-details">
                        ...
                        <div class="contact-form wow bounceInRight">
                            ...
                            <form name="sentMessage" id="contactForm"  novalidate>
                                ...
                                <div class="col-md-12">
                                    <textarea rows="6" cols="100" class="form-control"  placeholder="Message" id="message" required data-validation-required-message="Please enter your message" minlength="5"  data-validation-minlength-message="Min 5 characters"  maxlength="999" style="resize:none"></textarea>
                                </div>
            ...
            <section id="clients" class="clients-section">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                            <h2>
                                <span class="highlight-text">Customer Feedback</span>
                            </h2>
                        </div>
                        <!-- Section Header -->
                        <div class="row">
