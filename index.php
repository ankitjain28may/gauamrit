                        ...
                        <div class="menu row">
                            ...
                            <div class="col-md-6 wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">
                                <div class="menu-column">
                                    <div class="food">
                                        <div class="food-desc">
                                            <h6 class="food-name">Cow Milk</h6>
                                            <div class="dots"></div>
                                            <div class="food-price">
                                                <span>50.00 /-</span>
                                            </div>
                        ...
                        <div class="menu row">
                            <div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="menu-column">
                                    <div class="food">
                                        <div class="food-desc">
                                            <h6 class="food-name">Toned Milk</h6>
                                            <div class="dots"></div>
                                            <div class="food-price">
                                                <span>39.00 /-</span>
                                            </div>
                        ...
                        <div class="menu row">
                            <div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="menu-column">
                                    <div class="food">
                                        <div class="food-desc">
                                            <h6 class="food-name">Seasonable Gujia</h6>
                                            <div class="dots"></div>
                                            <div class="food-price">
                                                <span>450.00 /-</span>
                                            </div>
                            ...
                            <div class="col-md-6 wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">
                                <div class="menu-column">
                                    <div class="food">
                                        <div class="food-desc">
                                            <h6 class="food-name">Sugar Free Gujia</h6>
                                            <div class="dots"></div>
                                            <div class="food-price">
                                                <span>500.00 /-</span>
                                            </div>
                        ...
                        <div class="menu row">
                            <div class="col-md-6 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                                <div class="menu-column">
                                    <div class="food">
                                        <div class="food-desc">
                                            <h6 class="food-name">Desi Ghee</h6>
                                            <div class="dots"></div>
                                            <div class="food-price">
                                                <span>1200.00 /-</span>
                                            </div>
                        ...
                        <div class="contact-form wow bounceInRight">
                            ...
                            <form name="sentMessage" id="contactForm"  novalidate>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <br/>
                                    <div id="success"></div>
                                    <button type="submit" class="btn btn-primary"><span class="submitMsg">Submit Message</span><span class="showNotif">Message Sent</span></button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <section class="footer-container">
                <div class="container">
                    <div class="row footer-containertent">
                        ...
                        <div class="col-md-4 col-md-offset-3  contact-us">
                            <h4>Contact Us</h4>
